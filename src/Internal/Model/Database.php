 ...
 *
 * @description One database FAMILY, with your organization&#39;s licence beside it. A licence covers the family, while a download names a specific version, so the ids passed to &#x60;download&#x60; and &#x60;checksum&#x60; come from &#x60;versions&#x60;.
 * @package  InternetData\Internal
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Database implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'name' => 'string',
        'summary' => 'string',
        'standing' => '\InternetData\Internal\Model\Standing',
        'license_type' => 'string',
        'starts' => '\DateTime',
        'expires' => '\DateTime',
        'renews_at' => '\DateTime',
        'notice_due_at' => '\DateTime',
        'versions' => '\InternetData\Internal\Model\DatabaseVersion[]'
    ];
     ...
     * Sets base
     *
     * @param string $base The family, e.g. `vpn_ip`. What a licence is held against.
     *
     * @return $this
     */
     ...
     * Sets summary
     *
     * @param string $summary One line on what the newest version contains.
     *
     * @return $this
     */
     ...
     * Gets standing
     *
     * @return \InternetData\Internal\Model\Standing
     */
    public function getStanding(): \InternetData\Internal\Model\Standing
    {
     ...
     * Sets standing
     *
     * @param \InternetData\Internal\Model\Standing $standing standing
     *
     * @return $this
     */
    public function setStanding(\InternetData\Internal\Model\Standing $standing): static
    {
        if (is_null($standing)) {
     ...
     * Sets license_type
     *
     * @param string|null $license_type What your licence permits you to do with the data. Null when there is no licence, which is every family with standing `unlicensed`.
     *
     * @return $this
     */
     ...
     * Sets expires
     *
     * @param \DateTime|null $expires A hard stop. Null when the licence has no end date, which is the normal case for a rolling agreement, and when there is no licence. A rolling licence reports its turnover date in renews_at instead.
     *
     * @return $this
     */
     ...
     * Sets renews_at
     *
     * @param \DateTime|null $renews_at When a rolling licence next renews. Null when the licence has no defined term, when expires sets a hard stop instead, and when there is no licence.
     *
     * @return $this
     */
     ...
     * Gets versions
     *
     * @return \InternetData\Internal\Model\DatabaseVersion[]
     */
     ...
     * Sets versions
     *
     * @param \InternetData\Internal\Model\DatabaseVersion[] $versions Every published version of this family, oldest first. Old versions are frozen rather than migrated, so both stay downloadable.
     *
     * @return $this
     */
