...
class Database implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets standing
     *
     * @param string $standing `licensed` is a live grant, `expired` one whose term has ended, and `unlicensed` a database published but never bought.
     *
     * @return $this
     */
     ...
     * Sets license_type
     *
     * @param string|null $license_type What your licence permits you to do with the data. Null when there is no licence.
     *
     * @return $this
     */
