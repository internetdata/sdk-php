 ...
 *
 * @description One database FAMILY, with your organization&#39;s license beside it. A license covers the family, while a download names a specific version, so the ids passed to &#x60;download&#x60; and &#x60;checksum&#x60; come from &#x60;versions&#x60;.
 * @package  InternetData\Internal
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Database implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets base
     *
     * @param string $base The family, e.g. `vpn_ip`. What a license is held against.
     *
     * @return $this
     */
     ...
     * Sets license_type
     *
     * @param string|null $license_type What your license permits you to do with the data. Null when there is no license, which is every family with standing `unlicensed`.
     *
     * @return $this
     */
