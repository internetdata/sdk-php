...
class Download implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets bytes
     *
     * @param int|null $bytes Object size at redirect time, NOT bytes delivered: the transfer is a presigned redirect straight to object storage, so we never observe how much of it was taken.
     *
     * @return $this
     */
     ...
     * Sets apikey_id
     *
     * @param string|null $apikey_id The key that made the request. Null when it could not be resolved.
     *
     * @return $this
     */
