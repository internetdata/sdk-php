...
class DbChecksums implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets md5
     *
     * @param string $md5 Hex-encoded MD5 digest.
     *
     * @return $this
     */
     ...
     * Sets sha1
     *
     * @param string $sha1 Hex-encoded SHA-1 digest.
     *
     * @return $this
     */
     ...
     * Sets sha256
     *
     * @param string $sha256 Hex-encoded SHA-256 digest.
     *
     * @return $this
     */
     ...
     * Sets sha512
     *
     * @param string $sha512 Hex-encoded SHA-512 digest.
     *
     * @return $this
     */
