...
class DatabaseMetadata implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'updated' => '\DateTime',
        'entries' => 'int',
        'schema' => 'array<string,\InternetData\Internal\Model\DatabaseMetadataColumn[]>',
     ...
     * Sets updated
     *
     * @param \DateTime $updated ISO-8601 date (YYYY-MM-DD) the published build was generated on.
     *
     * @return $this
     */
     ...
     * Gets schema
     *
     * @return array<string,\InternetData\Internal\Model\DatabaseMetadataColumn[]>
     */
     ...
     * Sets schema
     *
     * @param array<string,\InternetData\Internal\Model\DatabaseMetadataColumn[]> $schema Columns, keyed by format.
     *
     * @return $this
     */
     ...
     * Sets size
     *
     * @param array<string,int> $size Bytes per format.
     *
     * @return $this
     */
