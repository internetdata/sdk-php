...
class DatabaseVersion implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public const FORMATS_CSVGZ = 'csvgz';
    public const FORMATS_MMDB = 'mmdb';
     ...
     * @return string[]
     */
    public static function getFormatsAllowableValues()
    {
        return [
            self::FORMATS_CSVGZ,
            self::FORMATS_MMDB,
     ...
     * Sets formats
     *
     * @param string[] $formats The formats this version is BUILT in. Asking for another is a 400, not a gap - the `_provider` catalogs are keyed by provider id, so no MMDB exists for them.
     *
     * @return $this
     */
    public function setFormats(array $formats): static
    {
        ...
        $allowedValues = self::getFormatsAllowableValues();
