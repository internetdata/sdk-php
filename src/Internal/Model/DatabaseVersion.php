...
class DatabaseVersion implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'version' => 'int',
        'summary' => 'string',
        'formats' => '\InternetData\Internal\Model\DatabaseFormat[]'
    ];
     ...
     * Sets id
     *
     * @param string $id The versioned id. Pass this to `download`, `checksum` and `metadata`.
     *
     * @return $this
     */
     ...
     * Sets formats
     *
     * @param \InternetData\Internal\Model\DatabaseFormat[] $formats The formats this version is BUILT in. Asking for another is a 400, not a gap - the `_provider` catalogs are keyed by provider id, so no MMDB exists for them.
     *
     * @return $this
     */
