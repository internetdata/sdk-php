...
/**
 * The database catalog and its downloads, which is the whole of this API.
 *
 * Reached as `$client->database`. Named `DatabaseApi` rather than `Database`
 * because `Database` is already the shape of one database family, and it is
 * what the other InternetData SDKs call this class.
 */
