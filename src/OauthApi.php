...
final class OauthApi
{
    ...
    /**
     * Built by hand and sent through `Transport`: this package generates no
     * Authorization API, whose send path would set no timeout anyway.
     *
     ...
     */
    private static function refusal(ResponseInterface $response): InternetDataException
    {
